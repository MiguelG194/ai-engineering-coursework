...
This repository contains my submission for CSC495's assignment.
...
Set the required API key as an environment variable, then run:
...
The script will then send a prompt to a DeepSeek model and print the response.
